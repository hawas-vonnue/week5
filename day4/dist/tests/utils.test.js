import { addToWatchList, createCard, createSearchResultCard, register, } from "../utils/util";
...
describe("createCard event listeners", () => {
    document.body.innerHTML = `
        ...
        `;
    const card = createCard("test", "10", ["hello"], "https://m.media-amazon.com/images/M/MV5BMDFkYTc0MGEtZmNhMC00ZDIzLWFmNTEtODM1ZmRlYWMwMWFmXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_QL75_UX380_CR0,1,380,562_.jpg", "2010", "tt2543164", "true");
    ...
    test("create search result card", async () => {
        const card = await createSearchResultCard("hello", "2012", "https://m.media-amazon.com/images/M/MV5BMDFkYTc0MGEtZmNhMC00ZDIzLWFmNTEtODM1ZmRlYWMwMWFmXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_QL75_UX380_CR0,1,380,562_.jpg");
    ...
    test("fall back link works:", () => {
        const card = createCard("inception", "10", ["Drama", "Psychological"], "https://m.media-amazon.com/images/M/MV5BYWM1YmZkNTctZDAwNy00ZTY4LWFjMTktYzU4ZjViMmU1OTJmXkEyXkFqcGdeQXVyMTA0MTM5NjI2._V1_QL75_UX380_CR0,4,380,562_.jpg", "20110", "10001", "true");
