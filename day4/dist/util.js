...
export function createCard(name, rating, genres, posterSrc, year, imdbID = null, button = "false") {
...
export function createModal() {
    ...
    overlay.append(searchElement, spinnerElement, warningElement, searchResultContainer, closeOverlayButton);
    ...
    searchButton.addEventListener("click", () => {
        ...
        if (searchButton.previousElementSibling instanceof HTMLInputElement) {
            ...
            searchMovie(searchValue).then((searchResults) => {
...
export async function searchMovie(name) {
    ...
    for (let movie of movieArray) {
        let card = createSearchResultCard(movie.Title, movie.Year, movie.Poster);
