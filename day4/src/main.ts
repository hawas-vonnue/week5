...
export function onRouteChange(path: string, params: object) {
    store.dispatch({
        type: "ROUTE_CHANGED",
        payload: {
            path,
...
export async function onMoviesListChange(type: "add" | "delete", id: string) {
...
store.subscribe("ROUTE_CHANGED", (state: State) => {
